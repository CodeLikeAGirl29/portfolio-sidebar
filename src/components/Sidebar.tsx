          ...
          >
            ...
            <div onClick={() => isMobile() && setOpen(false)}>
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                style={{ display: "inline-block" }} // Ensures the wrapper fits the content
  ...
  return (
    <div className="flex space-x-2">
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Lindsey H</p>
        {/* Consider updating this subtitle to match your new real estate focus! */}
